...
public class DatabaseManager {
    ...
    // ambil soal dari database dgn tingkat kesulitan sesuai d bagian distribution
    // difficulty
    ...
    private String convertToDbGender(String uiGender) {
        if (uiGender == null)
            return "Male"; // defaultnya cwo biar nda dinikahin soekarno
